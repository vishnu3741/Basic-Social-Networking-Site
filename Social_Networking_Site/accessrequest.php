...
<a href="adminpage.html" class="btn btn-success" style="font-family:Comic Sans MS;text-decoration : none; width:120px;">Admin Home</a>
  <div class="top-centere"><font size="60" color ="BLACK" style="font-family:Comic Sans MS;"><b>User Requests !</b></font></div><br><br>
...
while ($i < $num)
    ...
    $Name=pg_result($result,$i,"userid");
    $Email=pg_result($result,$i,"email");
    $Subject=pg_result($result,$i,"subject");
    $Description=pg_result($result,$i,"issue");
